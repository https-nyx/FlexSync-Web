  ...
  return (
    <div className="features-page-container">
      ...
      <div className="features-page-top-container">
        <header
          data-thq="thq-navbar"
          className="features-page-navbar-interactive"
        >
          ...
          <div data-thq="thq-navbar-nav" className="features-page-desktop-menu">
            <nav className="features-page-links">
              <span className="features-page-text02">
                <span>Home</span>
                <br></br>
              </span>
              <span className="features-page-text05">Features</span>
              <span className="features-page-text06">Preview</span>
            </nav>
            <div className="features-page-buttons">
              <button className="features-page-login button">Login</button>
              <button className="features-page-register button">
                Register
              </button>
            </div>
          </div>
          <div data-thq="thq-burger-menu" className="features-page-burger-menu">
            <svg viewBox="0 0 1024 1024" className="features-page-icon">
              <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
            </svg>
          </div>
          <div data-thq="thq-mobile-menu" className="features-page-mobile-menu">
            <div className="features-page-nav">
              <div className="features-page-top">
                <Link to="/" className="features-page-navlink1">
                  <h1 className="features-page-logo1">
                    <span className="features-page-text07">FLEX</span>
                    <span className="features-page-text08">SYNC</span>
                  </h1>
                </Link>
                <div
                ...
                >
                  <svg viewBox="0 0 1024 1024" className="features-page-icon02">
                    <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                  </svg>
                </div>
              </div>
              <nav className="features-page-links1">
                ...
                <Link to="/admin-login-page" className="features-page-login1">
                  Login
                </Link>
                <Link to="/sign-up-page" className="features-page-get-started">
                  Register
                </Link>
              </nav>
            </div>
        ...
        <div className="features-page-features1">
          <h1 className="features-page-text09">
            <span className="features-page-text10">
              All these
              <span
            ...
            <span className="features-page-text11">impressive features</span>
            <br className="features-page-text12"></br>
      ...
      <div id="contact" className="features-page-footer">
        <div className="features-page-mobile-footer">
          ...
          <div className="features-page-links-container">
            <span className="features-page-text15">
        ...
        <div className="features-page-desktop-footer">
          <div className="features-page-menu">
            <h1 className="features-page-logo2">FlexSync</h1>
            ...
            <div className="features-page-follow-container">
              <span className="features-page-text19">
                Follow us on
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
