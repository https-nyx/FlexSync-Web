...
const LandingPage = (props) => {
  return (
    <div className="landing-page-container">
      ...
      <header data-thq="thq-navbar" className="landing-page-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="landing-page-desktop-menu">
          <nav className="landing-page-links">
            <span className="landing-page-text02">
              <span>Home</span>
              <br></br>
            </span>
            <span className="landing-page-text05">Features</span>
            <span className="landing-page-text06">Preview</span>
          </nav>
        ...
        <div data-thq="thq-burger-menu" className="landing-page-burger-menu">
        ...
        <div data-thq="thq-mobile-menu" className="landing-page-mobile-menu">
          <div className="landing-page-nav">
            <div className="landing-page-top">
              <Link to="/" className="landing-page-navlink1">
                <h1 className="landing-page-logo1">
                  <span className="landing-page-text07">FLEX</span>
                  <span className="landing-page-text08">SYNC</span>
                </h1>
              </Link>
              <div
            ...
            <nav className="landing-page-links1">
              ...
              <Link to="/admin-login-page" className="landing-page-login1">
                Login
              </Link>
              <Link to="/sign-up-page" className="landing-page-get-started">
                Register
              </Link>
            </nav>
          </div>
      ...
      <div className="landing-page-top-container">
        <div className="landing-page-hero">
          <div className="landing-page-banner">
            ...
            <Link to="/sign-up-page" className="landing-page-learn-more button">
              <span>
                <span>
                  Get Started -
                  <span
                ...
                <span className="landing-page-text20">i</span>
                <span className="landing-page-text21">t&apos;s free</span>
              </span>
            </Link>
          </div>
        </div>
      ...
      <div id="contact" className="landing-page-footer">
        ...
        <div className="landing-page-desktop-footer">
          <div className="landing-page-menu">
            <h1 className="landing-page-logo2">FlexSync</h1>
